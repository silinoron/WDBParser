...
namespace WDBParser
{
    public sealed class WDBParser
    {
        ...
        public WDBParser(string folderName)
        {
            ...
            var xmlNodes = definitions.GetElementsByTagName("wdbId");
        ...
        void LoadDefinitions()
        {
            ...
            var defFileName = "wdb-definitions.xml";
            ...
            definitions.Load("wdb-definitions.xml");
